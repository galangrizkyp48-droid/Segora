        ...
        <div className="bg-background-light dark:bg-background-dark text-[#0d171b] dark:text-slate-100 min-h-screen font-display">
            <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root overflow-x-hidden max-w-md mx-auto bg-white dark:bg-background-dark shadow-xl">
                ...
                <div className="flex items-center bg-white dark:bg-background-dark p-4 pb-2 justify-between sticky top-0 z-50 border-b border-slate-100 dark:border-slate-800">
                    <div className="flex size-12 shrink-0 items-center">
                        <div
                            ...
                            style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCvk-6Jvm93jiMeEljFbaOwYBHYDHWReM0g6LcylWJUXVUU-_BB-Nir7f_QYT4J7fwuZP7VB6hlv3l648L_eeGk9xoMcY3kq7jF77b02lKXO2Gq7H3l4v26A2IDjkdNGXb511uVvhVGyta84xn7nV73LB7EuqMVYEs6zUgrWsbPYgWcxSLvTJwI7D-sOJDep30BhpxcZLNo3W6FEZQxSje_qb7iBvZy61p-VMzRwi_uQ0N4TM9eTXS89cmi_YP-hKnsD8CdC84E-JI")' }}
                        >
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-3 px-4 pb-4">
                    <div className="flex flex-1 gap-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 items-center shadow-sm cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                    ...
                    <div className="flex flex-1 gap-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 items-center shadow-sm cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                        ...
                        <h2 className="text-[#0d171b] dark:text-white text-sm font-bold leading-tight">Toko</h2>
                    </div>
                </div>
